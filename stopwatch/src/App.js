            ...
            <Stack className="center_button" spacing={2} direction="row">
              ...
              >
                {isRunning ? (
                  ...
                  >
                    <path
                      d="M81.5 39.4737C88.8334 43.7076 88.8333 54.2924 81.5 58.5263L41 81.909C33.6666 86.1429 24.5 80.8505 24.5 72.3827L24.5 25.6173C24.5 17.1495 33.6667 11.8571 41 16.091L81.5 39.4737Z"
                      fill="#656565"
                    />
                  </svg>
                )}
